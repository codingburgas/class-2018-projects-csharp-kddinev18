...
namespace DiabetesTracker.Migrations
{
    ...
    [Migration("20220505144728_Add intermediate tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiabetesTracker.Models.BlogPost", b =>
                {
                    b.Property<int>("BlogId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DiabetesTracker.Models.Favourite", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DiabetesTracker.Models.FollowingBlog", b =>
                {
                    ...
                    b.Property<int>("FollowedOn")
                        .HasColumnType("int");

                    b.HasKey("BlogId", "UserId");

                    b.HasIndex("FollowedOn");
            ...
            modelBuilder.Entity("DiabetesTracker.Models.FollowingBlog", b =>
                {
                    b.HasOne("DiabetesTracker.Models.User", "FollowedOnNavigation")
                        .WithMany("FollowingBlogs")
                        .HasForeignKey("FollowedOn")
                        .HasConstraintName("FK_FollowingBlogs.UserId")
                        .IsRequired();

                    b.HasOne("DiabetesTracker.Models.Blog", "User")
                        .WithMany("FollowingBlogs")
                        .HasForeignKey("UserId")
                        .HasConstraintName("FK_FollowingBlogs.BlogId")
                        .IsRequired();

                    b.Navigation("FollowedOnNavigation");
