...
namespace DiabetesTracker.Migrations
{
    ...
    [Migration("20220530094157_Add column FollowedCount in Blogs table")]
    partial class AddcolumnFollowedCountinBlogstable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.Blog", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.FavouritePost", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.FollowingBlog", b =>
                {
                    b.Property<int>("BlogId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.Menu", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.MenuRecipe", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.Post", b =>
                {
                    b.Property<int>("PostId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.PostComment", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.PostLike", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.PostTag", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.Recipe", b =>
                {
                    b.Property<int>("RecipeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.Tag", b =>
                {
                    b.Property<int>("TagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.UserProfile", b =>
                {
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.Blog", b =>
                {
                    b.HasOne("DataAccessLayer.Data.Models.User", "User")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.FavouritePost", b =>
                {
                    b.HasOne("DataAccessLayer.Data.Models.Post", "Post")
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.FollowingBlog", b =>
                {
                    b.HasOne("DataAccessLayer.Data.Models.Blog", "Blog")
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.MenuRecipe", b =>
                {
                    b.HasOne("DataAccessLayer.Data.Models.Menu", "Menu")
                        .WithMany("MenuRecipes")
                        .HasForeignKey("MenuId")
                        .HasConstraintName("FK_MenuRecipes.RecipeId")
                        .IsRequired();

                    b.HasOne("DataAccessLayer.Data.Models.Recipe", "Recipe")
                        .WithMany("MenuRecipes")
            ...
            modelBuilder.Entity("DataAccessLayer.Data.Models.PostTag", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Data.Models.Tag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagId")
